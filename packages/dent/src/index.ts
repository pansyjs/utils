 ...
 * ```
 */
export function dent(literals: TemplateStringsArray, ...interpolations: any[]): string
 ...
 * ```
 */
export function dent(text: string): string

export default function dent(literals: string | TemplateStringsArray, ...interpolations: any[]): string {
  let text!: string
